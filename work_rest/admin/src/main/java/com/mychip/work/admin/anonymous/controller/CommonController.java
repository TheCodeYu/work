...
import com.mychip.work.config.ServerConfig;
...
import com.mychip.work.utils.file.FileUploadUtils;
import com.mychip.work.utils.file.FileUtils;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = MyConfig.getDownloadPath() + fileName;
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = MyConfig.getProfile();
            // 数据库资源地址
